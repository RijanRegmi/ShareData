...
#MKSC
    ...
    def login(self):
        ...
        #username
        self.lblcontact = Label(page_Frame, text="username",   font=("arial", 18, "bold"), bg="#9FA8B2",fg="#FFFFFF", bd=4)
        self.lblcontact.place(x=105, y=120)

        self.txtcontact = ttk.Entry(page_Frame, font=("arial", 12, "bold"), width=24)
        self.txtcontact.place(x=50, y=160)
    ...
    def signup(self):
        ...
        self.btnlogin = Button(user_Frame, command=self.check_login, text="Login", height=50, font=('arial', 15, 'bold'), bg="#4f5c8b", fg="#FFFFFF", width=120, cursor="hand2")
